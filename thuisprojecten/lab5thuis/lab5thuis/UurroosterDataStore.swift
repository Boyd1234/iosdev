...
class UurroosterDataStore {
    ...
    init() {
        ...
        func deleteEvent(id: String) {
            uurrooster.removeAll(where: {$0.id == id }) //remove alles waar index gelijk is aan meegegeven index
        }
        
        func getEvent(id: String) -> EventModel? { //hier een optional toegevoegd
